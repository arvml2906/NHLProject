...
Links:
- [Experiment 0_Logistic Regression (distanct)](https://wandb.ai/IFT6758-2024-B04/ms2-q3-lr-baseline/runs/h64fbcx1)
- [Experiment 1_Logistic Regression (shotAngle)](https://wandb.ai/IFT6758-2024-B04/ms2-q3-lr-baseline/runs/f9ur94he)
- [Experiment 2_Logistic Regression (distanct, shotAngle)](https://wandb.ai/IFT6758-2024-B04/ms2-q3-lr-baseline/runs/zu9q9jom)
...
The simple model scored 0.934 on accuracy and 0.710 for auc.
- Link to Wandb:
...
.plot_importance).
Finally, after we had found the best selection method, we took the features it ouputed and performed hyperparameter tuning on that set to see if we would obtain a better performance than the model using all the features.
...
[Neural Network Feature Selection experiement in W&B](https://wandb.ai/IFT6758-2024-B04/ms2-q6-best-shot-fs?nw=nwusersergemalo)
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><img src="/assets/images/ms2_q6_fs_prop.png" alt="Feature selection Cumulative proprotion"></td>
...
We decided then to compare the current experiment that used only one feature ("distance", selected from previous section) to using all features. We made an **impotant discovery**: using all features with a mini batch of 32 gives the best results so far.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><img src="/assets/images/ms2_q6_mb_prop.png" alt="Mini-batch selection Cumulative proprotion"></td>
      <td><img src="/assets/images/ms2_q6_mb_calib.png" alt="Mini-batch selection Calibration plot"></td>
    </tr>
  </tbody>
</table>

From this point, we have decided to us all 10 input features to fine-tune the following hyper-parameters.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><img src="/assets/images/ms2_q6_arch_prop.png" alt="Architecture selection Cumulative proprotion"></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><img src="/assets/images/ms2_q6_lr_prop.png" alt="Learning Rate selection Cumulative proprotion"></td>
...
- Neural Nework with 2 fully connected hidden layer of 128x64 and 64x32 neurons, with ReLU activation
- Output layer of 32x1, with Sigmoid activation to produce probabilities
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><img src="/assets/images/ms2_q6_best_prop.png" alt="Best Neural Network selection Cumulative proprotion"></td>
...
#### Result for for models of section 3
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><img src="/assets/images/ms2_q7_1_model012_prop.png" alt="Logistic Regression Test set Cumulative proprotion"></td>
      <td><img src="/assets/images/ms2_q7_1_model012_calib.png" alt="Logistic Regression Test set Calibration plot"></td>
    </tr>
  </tbody>
</table>

#### Result for for model of section 6
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><img src="/assets/images/ms2_q7_1_model6_prop.png" alt="Neural Network Test set Cumulative proprotion"></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><img src="/assets/images/ms2_q7_2_model012_prop.png" alt="Logistic Regression Test set Cumulative proprotion"></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><img src="/assets/images/ms2_q7_2_model6_prop.png" alt="Neural Network Test set Cumulative proprotion"></td>
