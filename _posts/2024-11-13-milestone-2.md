...
### 3.4
 Next to the figures, include links to the three experiment entries in your Wandb projects that produced these three models. Save the three models to the three experiments on Wandb (example here) and register them with some informative tags, as you will need it for the final section.
...
[Neural Network test results on W&B](https://wandb.ai/IFT6758-2024-B04/ms2-q7-model6-regular?nw=nwusersergemalo)
<table>
  <thead>
  </thead>
  <tbody>
...
#### Result for for model of section 6
[Neural Network test results on W&B](https://wandb.ai/IFT6758-2024-B04/ms2-q7-model6-playoffs?nw=nwusersergemalo)
<table>
  <thead>
  </thead>
  <tbody>
