...
[Team B4 Dataset experiement in W&B](https://wandb.ai/IFT6758-2024-B04/ms2-q4-dataset-V0/artifacts/dataset/wpg_v_wsh_2017021065/v0/files/wpg_v_wsh_2017021065.table.json)
...
<table>
  ...
  <tbody>
    <tr>
      <td>Distance</td>
      <td>Distance of the event to the target goal.</td>
    </tr>
    <tr>
      <td>Bob</td>
      <td>4</td>
