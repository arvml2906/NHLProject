...
NOTE: The 'Non-Goals' are shots classified as 'shot-on-goal' and 'missed-shots'. Additionally, shot angles are higher for shots that are taken head-on. For example, a shot angle of 90 degrees means it is directed along the same line as taking a shot from the centre of the pitch towards goal.
...
<img src="/assets/images/Feature1_2Dhist.png" alt="2D histogram">
  ...
  - The darkest (densest) region is at short distances (0–20 feet) and high shot angles (80–90 degrees).
