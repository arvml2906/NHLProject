...
Finally, we just wanted to "push" our previous selections with a training over much more epochs. Instead of using 10 epochs, we trained our model with 100 epochs, and verified the evoluation of the results (Loss, ROC AUC) during the training.

[Here's the comparison in W&B](https://wandb.ai/IFT6758-2024-B04/ms2-q6-best-shot-epochs?nw=nwusersergemalo)
...
<table>
  ...
  <tbody>
    <tr>
      <td><img src="/assets/images/ms2_q7_model6_roc.png" alt="Neural Network Test set ROC"></td>
      <td><img src="/assets/images/ms2_q7_model6_gr.png" alt="Neural Network Test set Goal Rate"></td>
    </tr>
    <tr>
      <td><img src="/assets/images/ms2_q7_model6_prop.png" alt="Neural Network Test set Cumulative proprotion"></td>
      <td><img src="/assets/images/ms2_q7_model6_calib.png" alt="Neural Network Test set Calibration plot"></td>
    </tr>
  </tbody>
</table>