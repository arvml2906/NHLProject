...
```
   ...
   - Figuring out Game IDs for each season:
      ...
      ```
      In brief, suppose we take GAME_ID ``` 2019020901 ``` and GAME_ID ``` 2021030223 ``` , the breakdown from left to right would be as follows:
...
<img src="/assets/images/simple_viz_goal_conversion_vs_dist1.png" alt="Goal Conversion Rate for Seaons 2023, per shot type">
<img src="/assets/images/simple_viz_goal_conversion_vs_dist2.png" alt="Goal Conversion Rate for Seaons 2023, per shot type">
